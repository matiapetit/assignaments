namespace SommatoreNumeriDispari {
    partial class Form1 {
        ...
        private void InitializeComponent() {
            ...
            nmMin.Maximum = new decimal(new int[] { 99999999, 0, 0, 0 });
            nmMin.Minimum = new decimal(new int[] { 99999999, 0, 0, int.MinValue });
            nmMin.Name = "nmMin";
            ...
            // lbSomma
            // 
            lbSomma.AutoSize = true;
            lbSomma.Location = new Point(316, 175);
            lbSomma.Name = "lbSomma";
            lbSomma.Size = new Size(13, 15);
            lbSomma.TabIndex = 2;
            lbSomma.Text = "0";
            // 
            // btCalculate
            ...
            nmMax.Maximum = new decimal(new int[] { 99999999, 0, 0, 0 });
            nmMax.Minimum = new decimal(new int[] { 99999999, 0, 0, int.MinValue });
            nmMax.Name = "nmMax";
